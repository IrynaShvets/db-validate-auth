...
if (isset($_POST['submit'])) {
    if (isset($_POST['login'], $_POST['email'], $_POST['city'], $_POST['phone'], $_POST['sex'], $_POST['password'], $_POST['cpassword']) && !empty($_POST['login']) && !empty($_POST['email']) && !empty($_POST['city']) && !empty($_POST['phone']) && !empty($_POST['sex']) && !empty($_POST['password']) && !empty($_POST['cpassword'])) {
...
<body>
    ...
    <div class="form-container">
        ...
        <form class="form-register" method="POST" action="server.php">
